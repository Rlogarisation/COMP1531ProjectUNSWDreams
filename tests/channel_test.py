...
def test_channel_invite_v1_success():
    ...
    user_1_class = get_user_by_auth_id(user_1_id_auth)
    user_2_class = get_user_by_auth_id(user_2_id_auth)
    user_1_id = user_1_class.u_id
    user_2_id = user_2_class.u_id
...
def test_channel_invite_v1_inputErrorChannel():
    ...
    with pytest.raises(InputError):
        channel_invite_v1(user_1_id_auth, Channel_1_invalid_id, user_2_id)
...
def test_channel_invite_v1_inputErrorUser():
    ...
    with pytest.raises(InputError):
        channel_invite_v1(user_1_id_auth, Channel_1_id, user_2_id_invalid_id)
...
def test_channel_invite_v1_accessError():
    ...
    user_1_id_auth = user_1['auth_user_id']
    user_2_id_auth = user_2['auth_user_id']
    user_3_id_auth = user_3['auth_user_id']
    user_1_class = get_user_by_auth_id(user_1_id_auth)
    user_2_class = get_user_by_auth_id(user_2_id_auth)
    user_3_class = get_user_by_auth_id(user_3_id_auth)
    user_1_id = user_1_class.u_id
    user_2_id = user_2_class.u_id
    user_3_id = user_3_class.u_id
    ...
    with pytest.raises(AccessError):
        channel_invite_v1(user_2_id_auth, Channel_1_id, user_3_id)
...
def test_channel_details_v1_success_single():
    # Clears data and registers and logins user_1 and user_2
    clear_v1()
    user_1 = auth_register_v1('user1@gmail.com', 'user1pass', 'numerouno', 'uno')
    user_1 = auth_login_v1('user1@gmail.com', 'user1pass')
...
def test_channel_details_v1_success_multiple():
    # Clears data and registers and logins user_1 and user_2
    clear_v1()
    user_1 = auth_register_v1('user1@gmail.com', 'user1pass', 'numerouno', 'uno')
    user_2 = auth_register_v1('user2@gmail.com', 'user2pass', 'numerodos', 'dos')
