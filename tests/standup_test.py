...
#     time_finish_check = standup_start_v1(token1, channel_id1, 60)
...
#     token1 = auth_login_v1('haha@gmail.com', '123123123')['token']
#     channel_id1 = channels_create_v1(token1, 'ChannelOne', True)['channel_id']
#     invalid_channelid = channel_id1 + 'someRandomLetters'
#     with pytest.raises(InputError):
#         standup_start_v1(token1, invalid_channelid, 60)
...
#         standup_start_v1(invalid_token, channel_id1, 60)
...
#     token1 = auth_login_v1('haha@gmail.com', '123123123')['token']
#     channel_id1 = channels_create_v1(token1, 'ChannelOne', True)['channel_id']
#     invalid_channelid = channel_id1 + 'vwkudhbae'
#     standup_start_v1(token1, channel_id1, 60)
#     with pytest.raises(InputError):
...
#     token1 = auth_login_v1('haha@gmail.com', '123123123')['token']
#     channel_id1 = channels_create_v1(token1, 'ChannelOne', True)['channel_id']
#     invalid_channelid = channel_id1 + 'qytwiefvgiauwgfv'
#     standup_start_v1(token1, channel_id1, 60)
#     with pytest.raises(InputError):
