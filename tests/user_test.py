...
from src.user import user_profile_v1, user_profile_setname_v1, user_profile_setemail_v1, user_profile_sethandle_v1, users_all_v1
...
def test_user_profile_v1_success():
    ...
    user1 = user_profile_v1(token1, u_id1)
...
def test_user_profile_v1_successMultiple():
    ...
    # Calls the user_profile_v1 function for testing
    user1 = user_profile_v1(token1, u_id1)
    user2 = user_profile_v1(token2, u_id2)
